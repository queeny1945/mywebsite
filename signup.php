            ...
            <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container" action="signup.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="name" style="color:whitesmoke;"/>Nama</label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="Masukkan Nama">
                    </div>
                    <div class="form-group">
                        <label for="InputEmail" style="color:whitesmoke;"/>Alamat Email</label>
                    ...
                    <div class="form-group">
                        <label for="InputPassword" style="color:whitesmoke;"/>Password</label>
                    ...
                    <div class="form-group">
                        <label for="InputPassword" style="color:whitesmoke;"/>Re-Password</label>
                    ...
                    <div class="form-footer mt-2">
                        <p style="color:whitesmoke;"/> Sudah punya account? <a href="login.php">Login</a></p>
                    </div>
                </form>
            </section>
            </section>
